...
/**
 * struct data - struct that contains all relevent data on runtime
 * @av: argument vector
...
/**
 * struct line_list_s - slingly linked list
 * @line: command line
 * @next: next node
 ...
 * @name: name of the command built in i.e cd, exit, env...
 * @f: datatype pointer function
 */
